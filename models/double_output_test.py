...
def _build_network(sequence_length, img_width, img_height):
    ...
    # Reconstruct decoder
    decoder1 = RepeatVector(sequence_length)
    decoder1 = ConvLSTM2D(filters=128, kernel_size=(3,3), padding='same', return_sequences=True)(decoder1)
    ...
    # Predict decoder
    decoder2 = RepeatVector(sequence_length - 1)
    decoder2 = ConvLSTM2D(filters=128, kernel_size=(3,3), padding='same', return_sequences=True)(decoder2)
